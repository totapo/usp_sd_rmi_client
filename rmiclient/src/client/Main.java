...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		// args 0 = ip host
		// args 1 = porta rmi registry
		// args 2 = numero de repetições
		if (args.length >= 3) {
			for (int a = 0; a < Integer.parseInt(args[2]); a++) {
				Client client = new Client(args[0], Integer.parseInt(args[1]));
				try {
					System.out.println("voidPrimeiraChamada;" + client.testVoid() / 1000000f);
					...
					System.out.println(
							"8long;" + client.testEightLong(80, -200, 400, 600, 9123, 2, -1233, 42) / 1000000f);
